...
<div class="lg:w-[77.5%] lg:h-full md:w-full sm:w-full overflow-hidden">
    ...
    <div class=" min-h-screen lg:max-w-[1345px]  w-full  bg-[#FFFFFF] mt-3 rounded-xl p-[20px] overflow-y-scroll overflow-hidden">
        <p class="font-signika font-medium text-[24px]">Update Pengumuman</p>
        ...
        @method('put')
            <div class="w-full h-[80px] flex flex-col justify-between mt-3">
                <div class="w-full h-[80px] mb-5">
                    ...
                    <input value="{{ $announcement->title }}" name="title" type="text" class=" focus:outline-none w-full border  focus:ring focus:ring-[#0c720f]  h-[55px] rounded-xl pl-[20px] bg-[#FAFAFA]" placeholder="Masukan judul Pengumuman" required>
                </div>
                ...
                <div class=" w-full mt-4">
                    ...
                    <textarea  name="description" id="" cols="30" rows="10" class="focus:outline-none min-h-[130px] focus:ring focus:ring-[#0c720f] w-full h-[90px] rounded-xl pl-[20px] bg-[#FAFAFA] pt-[10px]" placeholder="Deskripsi Pengumuman" required>{{ $announcement->description }}</textarea>
                    </div>
                </div>
