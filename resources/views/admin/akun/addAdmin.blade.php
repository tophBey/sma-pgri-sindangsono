...
<div class="lg:w-[77.5%] lg:h-full md:w-full overflow-hidden">
           ...
           <div class="lg:mt-2 md:mt-28 sm:mt-28 sm:w-full md:w-full mb-3 lg:w-full h-[85px] flex justify-between mt-4 rounded-xl bg-[#FFFFFF] py-3 px-5 lg:max-w-[1345px] overflow-hidden">
            ...
            <div class="daftar-pesanan  min-h-[900px] lg:max-w-[1345px]  w-full  bg-[#FFFFFF] mt-3 rounded-xl p-[20px]  overflow-hidden">
                <p class="font-signika font-medium text-[24px]">Tambah Admin</p>
                ...
                @csrf
                    <div class="w-full  flex flex-col justify-between mt-3 mb-4">
                        <div class="w-full  mb-5">
                            ...
                            <input value="{{ old('name') }}" name="name" type="text" class=" focus:outline-none w-full border  focus:ring focus:ring-[#0c720f]  h-[55px] rounded-xl pl-[20px] bg-[#FAFAFA]" placeholder="Masukan Nama Admin" required>
                            @error('name')
                        ...
                        <div class="w-full  mb-5">
                            ...
                            <input name="email" type="email" value="{{ old('email') }}" class=" focus:outline-none w-full border  focus:ring focus:ring-[#0c720f]  h-[55px] rounded-xl pl-[20px] bg-[#FAFAFA]" placeholder="Masukan email" required>
                            @error('email')
                                <span class="text-red-500 mt-1 font-semibold ml-2 block py-1 text-sm">{{ $message }}</span>
                            @enderror
                        </div>
                         <div class="w-full  mb-4">
                            ...
                            <input name="avatar" type="file" class=" focus:outline-none w-full border  focus:ring focus:ring-[#0c720f]  h-[55px] rounded-xl pt-3 pl-[20px] bg-[#FAFAFA]" >
                            @error('avatar')
                                <span class="text-red-500 mt-1 font-semibold ml-2 block py-1 text-sm">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="w-full  mb-4">
                            ...
                            <input name="password" type="password" class=" focus:outline-none w-full border  focus:ring focus:ring-[#0c720f]  h-[55px] rounded-xl py-1 pl-[20px] bg-[#FAFAFA]" placeholder="Masukan password" required>
                            @error('password')
                                <span class="text-red-500 mt-1 font-semibold ml-2 block py-1 text-sm">{{ $message }}</span>
                            @enderror
                        </div>
