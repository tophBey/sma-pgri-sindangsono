...
<div class="lg:w-[77.5%] md:w-full lg:h-full sm:w-full overflow-hidden">
    ...
    <div class="  min-h-[900px] lg:max-w-[1345px]  w-full  bg-[#FFFFFF] mt-3 rounded-xl p-[20px]  overflow-hidden">
        <p class="font-signika font-medium text-[24px]">Tambah Berita</p>
        ...
        @csrf
            <div class="w-full  flex flex-col justify-between mt-3 mb-4">
                ...
                <div class=" w-full mt-4">
                    ...
                    <textarea  name="description" id="" cols="30" rows="10" class="focus:outline-none min-h-[130px] focus:ring focus:ring-[#0c720f] w-full h-[90px] rounded-xl pl-[20px] bg-[#FAFAFA] pt-[10px]" placeholder="Deskripsi Berita">{{ old('description') }}</textarea>
                    @error('description')
                            <span class="text-red-500 mt-1 font-semibold ml-6 block py-1 text-sm">{{ $message }}</span>
                    @enderror
                    </div>
