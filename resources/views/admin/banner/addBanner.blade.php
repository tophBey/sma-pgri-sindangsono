...
@section('content')
<div class="lg:w-[77.5%] md:w-full md:px-3 lg:px-0 lg:h-full overflow-hidden">
    ...
    <div class="  min-h-[900px] lg:max-w-[1345px] md:max-w-[1345px]  w-full  bg-[#FFFFFF] mt-3 rounded-xl p-[20px]  overflow-hidden">
        <p class="font-signika font-medium text-[24px]">Tambah Banner</p>

        <div class="form mt-5 mb-5 w-full h-[47px] flex justify-end">
            <a href="{{ route('admin.banner.index') }}" class="px-3 py-3 rounded-xl text-white font-semibold bg-[#0c720f] block">Kembali</a>
        </div>
        ...
        @csrf
            ...
            <div class="w-full  flex flex-col justify-between mt-3 mb-4">
                ...
                <div class="w-full  mb-4">
                    <p class="font-signika font-medium text-[14px] text-[#222831] mb-2">Foto Banner</p>
                    <input name="banner_image"  type="file" class=" focus:outline-none w-full border  focus:ring focus:ring-[#0c720f]  h-[55px] rounded-xl pt-3 pl-[20px] bg-[#FAFAFA]" required>
                    @error('banner_image')
                ...
                <div class="w-full  mb-5">
                    ...
                    <input name="title" value="{{ old('title') }}" type="text" class=" focus:outline-none w-full border  focus:ring focus:ring-[#0c720f]  h-[55px] rounded-xl pl-[20px] bg-[#FAFAFA]" placeholder="Masukan judul" required>
                    @error('title')
                        <span class="text-red-500 mt-1 font-semibold ml-6 block py-1 text-sm">{{ $message }}</span>
                    @enderror
                ...
                <div class="w-full  mb-5">
                    <p class="font-signika font-medium text-[14px] text-[#222831] mb-2">Sub Judul</p>
                    <input name="subtitle" value="{{ old('subtitle') }}" type="text" class="focus:outline-none w-full border  focus:ring focus:ring-[#0c720f]  h-[55px] rounded-xl pl-[20px] bg-[#FAFAFA]" placeholder="Masukan Sub judul" required>
                    @error('subtitle')
                        <span class="text-red-500 mt-1 font-semibold ml-6 block py-1 text-sm">{{ $message }}</span>
                    @enderror
                </div>
