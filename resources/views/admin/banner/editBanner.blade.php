...
<div class="lg:w-[77.5%] lg:h-full md:w-full sm:w-full overflow-hidden">
    ...
    <div class="  min-h-[900px] lg:max-w-[1345px]  w-full  bg-[#FFFFFF] mt-3 rounded-xl p-[20px]  overflow-hidden">
        <p class="font-signika font-medium text-[24px]">Update Banner</p>
        ...
        @method('put')
            ...
            <div class="w-full  flex flex-col justify-between mt-3 mb-4">
                ...
                <div class="w-full  mb-4">
                    ...
                    <img src="{{Storage::url($banner->banner_image)}}" alt="" class="rounded d-block mb-3 h-[120px]" width="120" height="80">

                    <input name="banner_image"  type="file" class=" focus:outline-none w-full border  focus:ring focus:ring-[#0c720f]  h-[55px] rounded-xl pt-3 pl-[20px] bg-[#FAFAFA]" >
                    <input type="hidden" name="oldImage" value="{{ $banner->banner_image }}">

                </div>

                <div class="w-full h-[80px] mb-5">
                    <p class="font-signika font-medium text-[14px] text-[#222831] mb-2">Judul</p>
                    <input value="{{ $banner->title }}" name="title" type="text" class=" focus:outline-none w-full border  focus:ring focus:ring-[#0c720f]  h-[55px] rounded-xl pl-[20px] bg-[#FAFAFA]" placeholder="Masukan judul" required>
                </div>
                <div class="w-full h-[80px] mb-5">
                    <p class="font-signika font-medium text-[14px] text-[#222831] mb-2">Sub Judul</p>
                    <input value="{{ $banner->subtitle }}" name="subtitle" type="text" class="focus:outline-none w-full border  focus:ring focus:ring-[#0c720f]  h-[55px] rounded-xl pl-[20px] bg-[#FAFAFA]" placeholder="Masukan Sub judul" required>
                </div>
