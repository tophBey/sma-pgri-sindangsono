...
<div class="lg:w-[77.5%] lg:h-full md:w-full sm:w-full overflow-hidden">
   ...
   <!-- header -->
    ...
    <div class="  min-h-[900px] lg:max-w-[1345px]  w-full  bg-[#FFFFFF] mt-3 rounded-xl p-[20px]  overflow-hidden">
        <p class="font-signika font-medium text-[24px]">Update Guru</p>

        <div class="form mt-5 mb-5 w-full h-[47px] flex justify-end">
            <a href="{{ route('admin.teacher.index') }}" class="px-3 py-3 rounded-xl text-white font-semibold bg-[#0c720f] block">Kembali</a>
        </div>
        ...
        @method('put')
            <div class="w-full flex flex-col justify-between mt-3 mb-4">
                <div class="w-full mb-5">
                    <p class="font-signika font-medium text-[14px] text-[#222831] mb-2">Nama Guru</p>
                    <input name="name" value="{{ $teacher->name }}"  type="text" class=" focus:outline-none w-full border  focus:ring focus:ring-[#0c720f]  h-[55px] rounded-xl pl-[20px] bg-[#FAFAFA]" placeholder="Masukan nama guru" required>
                    @error('name')
                ...
                <div class="w-full mb-4">
                    <p class="font-signika font-medium text-[14px] text-[#222831] mb-2">Foto Guru</p>
                    <img src="{{Storage::url($teacher->foto)}}" alt="" class="rounded d-block mb-3 h-[120px]" width="120" height="80">

                    <input name="foto"  type="file" class=" focus:outline-none w-full border  focus:ring focus:ring-[#0c720f]  h-[55px] rounded-xl pt-3 pl-[20px] bg-[#FAFAFA]">
                ...
                <div class="w-full mb-5">
                    <p class="font-signika font-medium text-[14px] text-[#222831] mb-2">Gelar</p>
                    <select name="degrees_id" id="" class="w-full border  focus:ring focus:ring-[#0c720f]  h-[55px] rounded-xl pt-1 pl-[20px] bg-[#FAFAFA]" required>
                        <option value="">Pilih Gelar</option>
                        @foreach ($degrees as $degree )

                            @if(old('degrees_id', $teacher->degrees_id) == $degree->id)
